...
if not up:
    st.info("👆 Upload your Excel/CSV. Filters: PU CTRY ∈ {DE, IT, IL} & STATUS = 440-BILLED. Grouping by POD month.")
    st.stop()
...
- **Net/Adjusted OTP** = counts **non-controllable** lates as on-time (QC NAME contains Agent / Delivery agent / Customs / Warehouse / W/house) ⇒ **Net ≥ Gross**.
""")
